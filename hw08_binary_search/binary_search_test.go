...
func TestBinarySearchInt64(t *testing.T) {
	tests := []struct {
		...
		{
			name:             "should find target element and return position when target element is on the first position",
			arr:              []int64{1, 2, 3, 4, 5},
			target:           1,
			expectedPosition: 0,
		},
		{
			name:             "should find target element an return position when target element is on the last position",
			arr:              []int64{1, 2, 3, 4, 5},
			target:           5,
			expectedPosition: 4,
		},
		{
			name:             "should find target element and return position when target element is on the middle position",
			arr:              []int64{1, 2, 3, 4, 5},
			target:           3,
			expectedPosition: 2,
		},
